...
DEFAULT_MODELS: dict[AuthProvider, str] = {
    ...
    AuthProvider.GEMINI: "gemini-2.0-flash",
    AuthProvider.GROK: "grok-4-0709",
    AuthProvider.MOONSHOT: "kimi-k2.6",
    AuthProvider.GLM: "glm-5.1",
    AuthProvider.MINIMAX: "MiniMax-M2.7",
