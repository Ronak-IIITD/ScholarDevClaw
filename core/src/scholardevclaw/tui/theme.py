...
COLORS = {
    ...
    "success": "#7CE38B",  # Distinct green for success states
    "warning": "#F6D17A",  # Distinct amber for warnings
    "error": "#F38BA8",  # Distinct red for errors
    "info": "#8CCEF5",  # Distinct blue for informational status
    # Borders/Separators
