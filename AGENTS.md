...
1. Always push to the code to Github after your todo is completed of that particular task
2. Always add the last updated + chanellog of the progress in UPDATES.md
